  ...
  ({
    palette: {
      ...
      text: {
        ...(mode === "light"
          ? {
              ...
              project: "#252733",
              test: "red",
              cardContent: grey[900],
              select: "#38383B",
              listSubheader: "rgba(37, 39, 51, 0.3)",
              highlight: "#0ACCB2",
            }
          : {
              primary: "#EFEFEF",
              ...
              project: "#EFEFEF",
              test: "blue",
              cardContent: grey[100],
              select: "#FFFFFF",
              listSubheader: "rgba(196, 196, 196, 0.43)",
              highlight: "#0ACCB2",
            }),
      },
      background: {
      ...
      success: {
        ...
        600: "#1DB45A",
        ...(mode === "dark" && {
          main: amber[300], // contrast 6.17:1 (blueDark.800)
        }),
        ...(mode === "light" && {
